...
// =============================================================================
// ROTAS DE TENANT (identificação por path: /{tenant}/...)
// =============================================================================
...
Route::prefix('{tenant}')
    ...
    ->group(function () {
        ...
        Route::middleware('auth')->group(function () {
            ...
            Route::get('/', fn () => redirect()->route('tenant.dashboard', ['tenant' => request()->route('tenant')]));
